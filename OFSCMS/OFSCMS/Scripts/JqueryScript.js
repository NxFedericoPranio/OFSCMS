...
function updateQueryStringParameter(uri, key) {
    ...
    return location.href.replace("page=" + value, "page=" + (parseInt(value) + 1).toString());
}
...
$(document).ready(function () {
    ...
    $("[href='" + scriptName + "']").parent().parent().parent().show(300);
    $("[href='" + scriptName + "']").parent().parent().parent().parent().children("a").children("#menuArrow").text("▼");

    $("#menu").children("ul").children("li").children("a").mouseenter(function () {
        if ($(this).parent().children('#menu2').length > 0) {
            $(this).children("#menuArrow").text("▼");
            $(this).parent().children('#menu2').show(300);
        }
    });

    $("#menu").children("ul").children("li").mouseleave(function () {
        if ($(this).children('#menu2').children("ul").children("li").children("a[href='" + scriptName + "']").length == 0) {
            $(this).children("a").children("#menuArrow").text("►");
            $(this).children('#menu2').hide(300);
        }
    });
