...
{
    public class GuestMessagesXml: OFSObjects
    {
        Serializator serializator = new Serializator();
        OFSObjectsXml baseObjectsManager = new OFSObjectsXml();

        public GuestMessagesXml(string path)
        {
            this.Path = path;
        ...
        {
            return baseObjectsManager.Delete<GuestMessage>(theEvent);
        }
        ...
        private List<IOFSObject> GetObjects(IOFSObject obj, bool deletedObject = false)
        {
            ...
            resultappo = baseObjectsManager.GetObjects<GuestMessage>(obj, deletedObject);
